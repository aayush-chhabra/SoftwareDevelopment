...
var FirstGenerator = yeoman.generators.Base.extend({
  ...
  askFor: function () {
    ...
    this.log(chalk.magenta("Welcome"));
  },
  ...
  app: function () {
    ...
    this.copy('templates2/_bower.json','app/bower.json');
    this.copy('templates2/_Gruntfile.js','app/Gruntfile.js'); 
    this.copy('templates2/_package.json','app/package.json');
    this.copy('templates2/_README.md','app/README.md');
